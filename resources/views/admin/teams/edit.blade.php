	...
	<div class="row g-3">
		...
		<div class="col-md-6">
			...
			<select name="division" class="form-select" required>
				...
				<option value="Manajemen" {{ old('division', $team->division) == 'Manajemen' ? 'selected' : '' }}>Manajemen</option>
				<option value="Marketing Executive" {{ old('division', $team->division) == 'Marketing Executive' ? 'selected' : '' }}>Marketing Executive</option>
				<option value="Back Office" {{ old('division', $team->division) == 'Back Office' ? 'selected' : '' }}>Back Office</option>
				<option value="Head Support" {{ old('division', $team->division) == 'Head Support' ? 'selected' : '' }}>Head Support</option>
			</select>
