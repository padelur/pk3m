...
@section('title', 'Tambah Produk - Makmur Mandiri Medika')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Tambahkan produk alat medis baru</p>
    </div>
...
<form method="post" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" class="card p-3">
	...
	<div class="row g-3">
		...
		<div class="col-md-6">
			...
			<input type="text" name="size" value="{{ old('size') }}" class="form-control" placeholder="Contoh: 10x15 cm, L, M, S">
			@error('size')<div class="text-danger small">{{ $message }}</div>@enderror
		</div>
		<div class="col-md-6">
			<label class="form-label">Link e-Katalog</label>
			<input type="url" name="e_catalog_url" value="{{ old('e_catalog_url') }}" class="form-control" placeholder="https://example.com">
